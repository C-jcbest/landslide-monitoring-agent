...
class GraphState(BaseModel):
    ...
    route: Literal["chat", "gnss"] = Field(default="chat", description="The planned graph route")
    ...
    chat_tool_rounds: int = Field(default=0, description="Number of chat read-only tool rounds in this turn")
